  ...
  return (
    <div className="max-w-2xl mx-auto px-6 py-10">
      <div className="text-center mb-8">
        <h1 className="text-3xl font-light text-black mb-4 tracking-tight">Domain Analysis</h1>
        <p className="text-base text-gray-600 font-light">Enter your domain and location to begin</p>
      </div>

      <div className="bg-white rounded-3xl shadow-xl border-0 p-8 backdrop-blur-sm bg-opacity-95">
        <form onSubmit={handleSubmit} className="space-y-6">
          ...
          <div className="space-y-3">
            ...
            <div className="relative">
              <input
                ...
                className={`w-full px-4 py-3 text-base font-light border rounded-2xl focus:outline-none focus:ring-2 focus:ring-gray-900 transition-all duration-300 bg-gray-50 ${
          ...
          <div className="space-y-3">
            ...
            <select
              ...
              className="w-full px-4 py-3 text-base font-light border border-gray-300 rounded-2xl focus:outline-none focus:ring-2 focus:ring-gray-900 focus:ring-offset-0 appearance-none bg-gray-50 focus:bg-white transition-all duration-300"
              required
            >
            ...
            <div className="grid grid-cols-2 gap-4">
              ...
              <div className="space-y-2">
                ...
                <select
                  ...
                  className="w-full px-3 py-2 text-sm font-light border border-gray-300 rounded-2xl focus:outline-none focus:ring-2 focus:ring-gray-900 appearance-none bg-gray-50 focus:bg-white transition-all duration-300 disabled:opacity-40"
                >
                  <option value="">Optional</option>
          ...
          <div className="border-t border-gray-100 pt-6">
            <button
              ...
              className="flex items-center text-gray-600 hover:text-gray-900 font-light text-base transition-colors duration-200"
            >
              Advanced Options
              ...
              <div className="mt-6 space-y-4 animate-fadeIn">
                <div className="space-y-2">
                  ...
                  <input
                    ...
                    className="w-full px-3 py-2 text-sm font-light border border-gray-300 rounded-2xl focus:outline-none focus:ring-2 focus:ring-gray-900 bg-gray-50 focus:bg-white transition-all duration-300"
                  />
                ...
                <label className="flex items-center space-x-3 cursor-pointer">
                  <input
                    ...
                    className="w-4 h-4 text-gray-900 border border-gray-300 rounded-md focus:ring-gray-900 focus:ring-2 transition-all duration-200"
                  />
          ...
          <div className="pt-4">
            <button
              ...
              className={`w-full py-3 px-5 bg-gray-900 text-white text-base font-medium rounded-2xl hover:bg-gray-800 focus:outline-none focus:ring-4 focus:ring-gray-200 transition-all duration-300 shadow-lg hover:shadow-xl transform hover:-translate-y-0.5 ${

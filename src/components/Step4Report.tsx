  ...
  return (
    <div className="min-h-screen bg-white">
      <div className="max-w-6xl mx-auto px-6 py-12">
        ...
        {/* Hero header */}
        <div className="bg-white rounded-3xl shadow-lg border-0 p-12 backdrop-blur-sm bg-opacity-95 mb-8">
        ...
        {/* Footer */}
        <div className="bg-white rounded-3xl shadow-lg border-0 p-8 backdrop-blur-sm bg-opacity-95">
          <div className="flex items-center justify-between">
            <button
